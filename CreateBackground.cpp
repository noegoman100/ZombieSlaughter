...
int createBackground(VertexArray& rVA, IntRect arena)
{
	...
	//Iterate through the Vertex Array - Setting up the Vertex Positions as well as the Texture Coordinates.
	for (int w = 0; w < worldWidth; w++)
	{
		for (int h = 0; h < worldHeight; h++)
		{
			...
			//IF I am an edge piece, then use a wall texture
			...
			else //Else (if not an edge piece, then use whatever random piece)
			{
